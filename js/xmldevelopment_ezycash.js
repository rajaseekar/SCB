function generateForm() {
	...
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou.html">');
			} else if ( $("input[name='form2_nationality']:checked").val() == "Singapore Permanent Resident" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou.html">');
 			} else {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou_f.html">');
			}
		} else {
			if ($("input[name='form2_nationality']:checked").val() == "Singaporean" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou_ss.html">');
			} else if ( $("input[name='form2_nationality']:checked").val() == "Singapore Permanent Resident" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou_ss.html">');
			} else {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/ezycash_form_thankyou_fs.html">');
			}
		}
