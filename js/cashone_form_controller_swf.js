	...
	*/
	...
	if( cash300Found ) {
		...
		if(  subChanCode != "" && subChanCode != "true" && subChanCode != "undefined" ) {
			...
			hiddenXML=hiddenXML+"\t\t\t<subChanCode>IB12</subChanCode>\n";
		}
	}
	...
	// general for cashone - add Star Trek option on 12 Dec 2012
	var prodType = jQuery.query.get("prodType")+'';
	var prodTypeStr = ""; 
	if( prodType != "" && prodType != "true" && prodType != "undefined" ) {
		prodTypeStr = prodType;
	} else {
		prodTypeStr = "28001";
	}
	var promoCode = jQuery.query.get("promoCode")+'';
	var promoCodeStr = ""; 
	if( promoCode != "" && promoCode != "true" && promoCode != "undefined" ) {
	...
	//card2_XML=startXML+"\t\t\t<prodType>28001</prodType>\n"+commonXML+"\t\t\t<promoCode>9168</promoCode>\n"+hiddenXML+addXML+endXML;
...
//		errorContainer: "#errorMessageBox_step1",
        ...
        errorPlacement: function(error, element) {
        	if (element.attr("name") == "form2_employer_unit_number")
       			...
       			error.insertAfter("#form2_job_title_label_container");
 			else if (element.attr("name") == "form2_cheque_acc_no")
       			error.insertAfter("#form2_cheque_acc_no_label_container");
     		else if (element.attr("name") == "form2_other_bank_acc_no")
       			error.insertAfter("#lbl_form2_other_bank_acc_no");
     		else if (element.attr("name") == "form2_other_bank_acc_no_verify")
       			...
       			error.insertAfter("#form2_issuing_bank_label_container");
     		else if (element.attr("name") == "form2_date_of_birth")
