	...
	if (true)
	{
		...
		if (jQuery('#form2_email_address').val() != "" || jQuery('#form2_mobile').val() != "")
		{
			...
			var url = leads_url + 'capture?' 
				...
				+'&leadcard='+encodeURIComponent('PL')
...
function onCompleted()
{
	...
	var url = leads_url + 'success?form='+formid+'&mobile='+jQuery('#form2_mobile').val()+'&email='+jQuery('#form2_email_address').val()+'&tqid='+tqid+'&leadcard='+'PL'+'&country='+country;
