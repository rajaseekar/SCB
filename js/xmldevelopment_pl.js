function generateForm() {
	...
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_f_aip.html">');
			}
		} else {
			if ($("input[name='form2_nationality']:checked").val() == "Singaporean" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_ss_aip.html">');
			} else if ( $("input[name='form2_nationality']:checked").val() == "Singapore Permanent Resident" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_ss_aip.html">');
			} else {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_fs_aip.html">');
			}
		}
