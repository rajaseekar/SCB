function generateForm() {
	...
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip.html">');
			} else if ( $("input[name='form2_nationality']:checked").val() == "Singapore Permanent Resident" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip.html">');
 			} else {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip_f.html">');
			}
		} else {
			if ($("input[name='form2_nationality']:checked").val() == "Singaporean" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip_ss.html">');
			} else if ( $("input[name='form2_nationality']:checked").val() == "Singapore Permanent Resident" ) {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip_ss.html">');
			} else {
	$('#hiddenForm').append('<input type="hidden" name="thankYouPage" id="thankYouPage" value="/public_website/singapore/OnlineSales/cashone_form_thankyou_aip_fs.html">');
			}
		}
